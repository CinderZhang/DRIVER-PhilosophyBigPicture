...
[^version]: Version 2.0 — Emphasizing Flexibility and Iteration
...
- [ ] Resources identified (data, tools, time, skills)
- [ ] Constraints known (deadlines, limitations, stakeholders)
- [ ] Key unknowns articulated

**REPRESENT**
- [ ] Approach documented (diagram, outline, or description)
- [ ] Dependencies understood
- [ ] Checkpoints planned
- [ ] Alternatives considered

**IMPLEMENT**
- [ ] Started with simple version
- [ ] Can explain every significant piece
- [ ] Key decisions documented
- [ ] AI used for bounded, verifiable tasks

**VALIDATE**
- [ ] Tested against known-good answers
- [ ] Reasonableness checks applied
- [ ] Edge cases explored
- [ ] AI-specific failure modes checked
...
|------------------|-----------------|
| Plan doesn't match what you're building | REPRESENT |
| Implementing something not in the plan | REPRESENT |
| Solution works but doesn't solve the real problem | DISCOVER |
| Stakeholders aren't satisfied | DISCOVER |
| Fundamental logic is flawed | REPRESENT or IMPLEMENT from scratch |
| Can't verify something works | VALIDATE (don't move forward) |
